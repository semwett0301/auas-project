...
#                    f"{Path(__file__).resolve().parent}/data/result/movie.xlsx")

prepare_award_xlsx(f"{Path(__file__).resolve().parent}/data/init/metaClean43Brightspace.xlsx", "Sheet1",
                   f"{Path(__file__).resolve().parent}/data/result/award.xlsx", f"{Path(__file__).resolve().parent}/data/result/award_movie.xlsx")
